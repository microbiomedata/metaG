...
import "annotation_mt_full.wdl" as awf
...
import "metaT_part2.wdl" as metat2
...
workflow nmdc_metat {
  ...
  call metat2.metat_omics as mt2 {
    input: metat_contig_fn = asm.assem_fna_file,
           non_ribo_reads = bbduk_rrna.non_rrna_reads,
           ann_gff_fn = annotation.functional_gff,
           no_of_cpus = 32,
           name_of_proj = proj
  }
